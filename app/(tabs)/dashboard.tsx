...
export default function Dashboard() {
  ...
  // Authentication is handled by AuthGuard in the layout
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      // Convert CompanyWithRole to Enterprise for compatibility
      const enterprises = companies.map(company => ({
        id: company.id,
        raisonSociale: company.name,
        identifiantFiscal: company.taxId || 'N/A',
        formeJuridique: 'SARL' as any, // Default value
        regimeFiscal: 'IS + TVA' as any, // Default value
